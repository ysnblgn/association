...
{{--    <style type="text/css">--}}
{{--        .login-page {--}}
{{--            background: url('/images/settings/sakarya.jpg') no-repeat center center fixed;--}}
...
<div class="login-box">
    <div class="login-logo">
        <a style="color: black;" href="{{route('ybadmin.Login')}}"><b>YB</b> YAZILIM</a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
        ...
        <form action="{{route('ybadmin.Authenticate')}}" method="post">
            @csrf
